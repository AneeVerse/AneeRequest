    ...
    const filtersElement = (
        <div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto">
            <div className="relative">
                ...
                {isFilterOpen && (
                    <div className="absolute right-0 mt-2 w-[calc(100vw-2rem)] sm:w-80 bg-[#101011] border border-shark rounded-2xl shadow-2xl p-4 z-50 space-y-4 animate-in fade-in slide-in-from-top-2 duration-200">
